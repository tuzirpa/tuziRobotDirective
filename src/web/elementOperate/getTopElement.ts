...
export const config: DirectiveTree = {
    name: 'web.elementOperate.getTopElement',
    sort: 3,
    displayName: '选择器获取顶层元素',
...
export const impl = async function ({
    ...
    try {
        ...
        // const finalSelector = toSelector(selector);

        // 在页面中执行元素过滤函数
        const filteredElement = await browserPage.evaluateHandle(({
            selector,
            isXPath,
            checkVisibility,
            checkOnTop,
